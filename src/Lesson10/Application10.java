    ...
    public static void main(String[] args) {
         ...
         * */
          ...
          /** 1. Создаем интерфейс Рeоplе и перечисляем методы который должны быть у будущего класса
           2. Создоем интерфейс Employer и перечисляем методы который должны быть у будущего класса Object＿ People＿
        Employe
        ...
        PythonDeveloper JavaDeveloper
           ...
           7. Но методы String getFullNome() и getAge() будут одинаковы для всех должностей
           Тогда делаем абстрактный класс AbstrEmployer
        Object
        People＿ (2 метода)
